...
export const TECH_STACKS: TechStack[] = [
  {
    ...
    description: "A fast, conversion-focused site with a custom design and clean content structure.",
  ...
  },
  {
    ...
    description: "A tailored, easy-to-manage website with hardened security and managed performance.",
